...
function EmployeeSelectModal({ visible, onClose, itineraryId, onSuccess }: EmployeeModalProps) {
    const router = useRouter();
    const [selectedId, setSelectedId] = useState<number | null>(null);

    const { data: empData, isLoading: empLoading } = useFetch<EmployeesApiResponse>({
        ...
        >
            <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={handleClose}>
                <TouchableOpacity activeOpacity={1} style={styles.modalSheet}>
                                    ...
                                    >
                                        <View style={styles.empInfo}>
                                            ...
                                            {!!item.department_name && (
                                                <Text style={styles.empDept}>{item.department_name}</Text>
                                            )}
                                        </View>
                                        {isSelected && (
                    ...
                    >
                        <>
                            <Ionicons name="chatbubble-ellipses-outline" size={18} color="#fff" style={{ marginLeft: 8 }} />
